...
# Dependencies from mo_application_php
cookbook 'wkhtmltox',           git: 'https://github.com/Desarrollo-CeSPI/wkhtmltox.git', tag: 'v0.1.2'

# Dependencies from mo_application_ruby

# Dependencies common for both
cookbook 'mo_application',      git: 'https://github.com/Desarrollo-CeSPI/mo_application.git', tag: 'v1.1.1'

# Our dependencies
cookbook 'mo_application_php',      git: 'https://github.com/Desarrollo-CeSPI/mo_application_php.git', tag: 'v1.1.1'
cookbook 'mo_application_ruby',      git: 'https://github.com/Desarrollo-CeSPI/mo_application_ruby.git', tag: 'v1.1.0'
